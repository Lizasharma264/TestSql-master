...
namespace TestSql
{
    public partial class Form1 : Form
    {
       // private string connectionString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=ClassDatabase;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
        ...
        private string connectionString = @"Data Source=VERMA\SQLEXPRESS;Initial Catalog=ClassDB;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
